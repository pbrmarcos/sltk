  ...
  public: {
    Tables: {
      ...
      chamados: {
        Row: {
          ...
          ultima_mensagem_por:
            | Database["public"]["Enums"]["chamado_autor_tipo"]
            | null
          updated_at: string
      ...
      documento_aprovacoes: {
        Row: {
          ...
          id: string
          status_anterior:
            | Database["public"]["Enums"]["documento_status"]
            | null
      ...
      logistica_embarque_status_log: {
        Row: {
          ...
          embarque_id: string
          from_status:
            | Database["public"]["Enums"]["logistica_embarque_status"]
            | null
          id: string
          notas: string | null
    ...
    Enums: {
      ...
      sat_item_tipo:
        ...
        | "parametro_operacional"
        | "cabecalho"
      sat_relatorio_status:
        | "rascunho"
        | "preenchendo"
        | "assinado"
        | "arquivado"
      tarefa_status: "aberta" | "concluida"
      template_evento_tipo:
        | "kickoff"
        | "fat"
        | "embarque"
        | "instalacao"
