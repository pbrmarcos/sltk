...
export function SparkKpi({ label, value, data, delta, deltaSuffix = "%", invertDelta, hint, color = "var(--primary)" }: Props) {
  ...
  return (
    <div className="rounded-[var(--radius-lg)] border border-[var(--bg-border)] bg-[var(--bg-surface)] p-4">
      ...
      <div className="mt-2 flex items-end justify-between gap-3">
        <div className="text-2xl font-semibold tabular-nums text-[var(--text-primary)]">{value}</div>
