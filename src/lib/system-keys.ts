...
export const CAPABILITIES: CapabilityDef[] = [
  ...
  },
  {
    ...
    descricao: "Porta de entrada para modelos de IA e para os conectores externos.",
    impacto: "Resumos, traduções automáticas e a sincronização com o Drive ficam indisponíveis.",
    area: "ia",
  ...
  },
  {
    id: "google_drive",
    label: "Google Drive",
    descricao: "Arquiva automaticamente PDFs de orçamentos, entrevistas e relatórios nas pastas do Drive.",
    impacto: "Documentos continuam sendo gerados e baixados normalmente, mas não são arquivados no Drive.",
    area: "documentos",
    criticidade: "importante",
    envs: ["LOVABLE_API_KEY", "GOOGLE_DRIVE_API_KEY"],
    envsOpcionais: ["GOOGLE_DRIVE_ROOT_FOLDER_ID"],
    testavel: true,
  },
  {
    id: "google_service_account",
    label: "Conta de serviço Google",
    descricao: "Alternativa de acesso ao Drive sem passar pelo gateway.",
    impacto: "Sem isso o arquivamento usa somente o conector padrão.",
    area: "documentos",
    criticidade: "opcional",
