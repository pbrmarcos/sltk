          ...
          <div className="space-y-5">
            ...
            >
              <p style={{ color: "var(--color-text-primary)" }}>
                Se houver uma conta com esse email, enviamos um link para redefinir sua
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5" noValidate>
            <div className="space-y-2">
              ...
              <div className="relative">
                <Mail className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2" style={{ color: "var(--color-text-muted)" }} />
                <Input
                  id="email"
                  type="email"
                  autoComplete="email"
