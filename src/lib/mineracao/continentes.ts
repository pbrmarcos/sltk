...
const MAPA: Record<string, string> = {
  ...
  CO: "América do Sul", EC: "América do Sul", PY: "América do Sul", PE: "América do Sul",
  UY: "América do Sul", VE: "América do Sul", GY: "América do Sul", SR: "América do Sul",
  // América do Norte e Central
  US: "América do Norte e Central", CA: "América do Norte e Central", MX: "América do Norte e Central",
  CR: "América do Norte e Central", DO: "América do Norte e Central", GT: "América do Norte e Central",
  HN: "América do Norte e Central", NI: "América do Norte e Central", PA: "América do Norte e Central",
  PR: "América do Norte e Central", SV: "América do Norte e Central", CU: "América do Norte e Central",
  JM: "América do Norte e Central", TT: "América do Norte e Central", BZ: "América do Norte e Central",
  // Europa
  AT: "Europa", BE: "Europa", BG: "Europa", CY: "Europa", CZ: "Europa", DE: "Europa", DK: "Europa",
  EE: "Europa", ES: "Europa", FI: "Europa", FR: "Europa", GB: "Europa", GR: "Europa", HR: "Europa",
  HU: "Europa", IE: "Europa", IT: "Europa", LT: "Europa", LU: "Europa", LV: "Europa", MT: "Europa",
  NL: "Europa", NO: "Europa", PL: "Europa", PT: "Europa", RO: "Europa", RS: "Europa", RU: "Europa",
  SE: "Europa", SI: "Europa", SK: "Europa", CH: "Europa", UA: "Europa",
  // Ásia
  BD: "Ásia", CN: "Ásia", ID: "Ásia", IL: "Ásia", IN: "Ásia", JP: "Ásia", KR: "Ásia", KZ: "Ásia",
  LK: "Ásia", MY: "Ásia", PH: "Ásia", PK: "Ásia", SA: "Ásia", SG: "Ásia", TH: "Ásia", TR: "Ásia",
  TW: "Ásia", UZ: "Ásia", VN: "Ásia", AE: "Ásia", QA: "Ásia", JO: "Ásia",
  // África
  EG: "África", ET: "África", KE: "África", LS: "África", MA: "África", NG: "África", UG: "África",
  ZA: "África", ZW: "África", TN: "África", GH: "África", TZ: "África", CI: "África",
  // Oceania
