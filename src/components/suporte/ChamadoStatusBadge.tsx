...
const STATUS_MAP: Record<string, { label: string; className: string }> = {
  ...
  aguardando_cliente: { label: "Aguardando cliente", className: "bg-violet-100 text-violet-800 border-violet-200" },
  ...
  arquivado: { label: "Arquivado", className: "bg-neutral-100 text-neutral-700 border-neutral-200" },
};
